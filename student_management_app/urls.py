...
urlpatterns = [
    ...
    path('staff_manage_clubs', StaffViews.staff_manage_clubs, name="staff_manage_clubs"),
    path('staff_create_club/', StaffViews.staff_create_club, name='staff_create_club'),
    ...
    path('student_view_clubs', StudentViews.student_view_clubs, name="student_view_clubs"),
